...
namespace Pomelo.DotNetClient
{
	public class MessageProtocol
	{
		...
		private JsonData encodeProtos = new JsonData();
		private JsonData decodeProtos = new JsonData();
		...
		public MessageProtocol(JsonData dict, JsonData serverProtos, JsonData clientProtos)
		{
